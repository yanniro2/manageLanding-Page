    ...
    return (
        <div className=' section relative overflow-hidden pt-[6rem] '>
            <div className="content z-10 Mobile:flex-col Mobile:text-center Mobile:items-center">
                <div className="left justify-center gap-8 Mobile:order-2 Mobile:items-center animate__animated animate__jackInTheBox">
                    <h1 className='h1'>
                        Bring everyone together to build better products.
                    </h1>
                    <p className='animate__animated  animate__fadeInRight'>  Manage makes it simple for software teams to plan day-to-day
                        tasks while keeping the larger team goals in view.</p>
                    <button className='btn w-[10rem]'> Get Started</button>
                </div>
                <div className="right flex items-center justify-center h-full order-1 animate__fadeInDown animate__animated">
