...
{
    return (
        <div className='w-full h-[6rem] fixed top-0 left-0 right-0 bg-white drop-shadow-sm shadow-sm flex justify-center font-viet z-[1000] bg-White overflow-hidden'>
